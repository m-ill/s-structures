...
await fs.mkdir(path.join(ROOT, 'verification', 'evidence', 'validation', 'phase11'), { recursive: true });
await fs.writeFile(
  path.join(ROOT, 'verification', 'evidence', 'validation', 'phase11', 'p11-m1-report-snapshot-verdict.json'),
