...
const EVIDENCE_PATH = path.join(ROOT, 'verification', 'evidence', 'validation', 'phase9', 'p9-m10-release-gate.json');
const DEBT_PATH = path.join(ROOT, 'verification', 'evidence', 'validation', 'phase9', 'p9-m10-final-debt.json');
const MANIFEST_PATH = path.join(ROOT, 'verification', 'specs', 'phase9', 'release-manifest.json');
const PRIOR_PATH = path.join(ROOT, 'verification', 'evidence', 'validation', 'phase9', 'p9-m9-product-workflow.json');
