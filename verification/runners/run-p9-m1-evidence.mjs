...
const EVIDENCE_PATH = path.join(ROOT, 'verification', 'evidence', 'validation', 'phase9', 'p9-m1-common-compute.json');
const MANIFEST_PATH = path.join(ROOT, 'verification', 'specs', 'phase9', 'release-manifest.json');
const BASELINE_PATH = path.join(ROOT, 'verification', 'evidence', 'validation', 'phase9', 'p9-m0-baseline.json');
