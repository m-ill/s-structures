 ...
 * Canonical owner: verification/runners/run-p11-m9-release.mjs
...
await runCompatibilityCli(new URL('../verification/runners/run-p11-m9-release.mjs', import.meta.url));
