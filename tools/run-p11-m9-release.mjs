...
const m8Evidence = await readJson(path.join(ROOT, 'reports', 'validation-evidence', 'phase11', 'p11-m8-qualification-hardening.json'));
...
const trackedManifestPath = path.join(ROOT, 'reports', 'validation-evidence', 'phase11', 'p11-release-manifest.json');
...
const evidencePath = path.join(ROOT, 'reports', 'validation-evidence', 'phase11', 'p11-m9-release-gate.json');
