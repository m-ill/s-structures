...
import { validatePhase8EvidenceArtifact } from '../src/verification/registry.js';
...
const OUT_ROOT = path.join(ROOT, 'reports', 'validation-evidence', 'phase9');
const RELEASE_ROOT = path.join(ROOT, 'docs', 'verification', 'phase9');
...
const actual = {
  ...
  syntheticKernelDistinction: {
    source: 'reports/validation-evidence/phase8/performance/p8-m11-reference-measurement.json',
