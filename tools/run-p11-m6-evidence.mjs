 ...
 * Canonical owner: verification/runners/run-p11-m6-evidence.mjs
...
await runCompatibilityCli(new URL('../verification/runners/run-p11-m6-evidence.mjs', import.meta.url));
