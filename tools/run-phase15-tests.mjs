 ...
 * Canonical owner: verification/harnesses/run-phase15-tests.mjs
...
await runCompatibilityCli(new URL('../verification/harnesses/run-phase15-tests.mjs', import.meta.url));
