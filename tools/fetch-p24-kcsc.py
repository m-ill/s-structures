...
folder=Path('verification/evidence/phase24/kcsc'); folder.mkdir(parents=True,exist_ok=True)
codes=['142010','142020','142022','142030','142050','142052','142070','142080','412000']
records=[]
for code in codes:
    ...
    try:
        ...
        print(json.dumps({'code':code,'bytes':len(data),'topKeys':list(parsed) if isinstance(parsed,dict) else 'array'}),flush=True)
