 ...
 * Canonical owner: verification/runners/run-p9-m2-evidence.mjs
...
await runCompatibilityCli(new URL('../verification/runners/run-p9-m2-evidence.mjs', import.meta.url));
