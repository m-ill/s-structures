...
try{
 const caseIds=process.argv[3]==='first-only'?['M-FIRST']:['M-FIRST','M-DIRECT'];
 const result=await bridge.runElasticWorkflow({plan:bridge.planElasticWorkflow({caseIds}),requestId:'M-diagnostic'});
