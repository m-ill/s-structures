 ...
 * Canonical owner: verification/runners/run-p15-m0-baseline.mjs
...
await runCompatibilityCli(new URL('../verification/runners/run-p15-m0-baseline.mjs', import.meta.url));
