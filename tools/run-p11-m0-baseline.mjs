...
await fs.mkdir(resolve('reports/validation-evidence/phase11'), { recursive: true });
await writeJson('reports/validation-evidence/phase11/p11-m0-baseline-governance.json', evidence);
await writeJson('docs/verification/phase11/release-manifest.json', manifest);
