 ...
 * Canonical owner: verification/harnesses/run-phase12-tests.mjs
...
await runCompatibilityCli(new URL('../verification/harnesses/run-phase12-tests.mjs', import.meta.url));
