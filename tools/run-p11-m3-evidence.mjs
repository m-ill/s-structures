 ...
 * Canonical owner: verification/runners/run-p11-m3-evidence.mjs
...
await runCompatibilityCli(new URL('../verification/runners/run-p11-m3-evidence.mjs', import.meta.url));
