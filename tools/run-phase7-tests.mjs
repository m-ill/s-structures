 ...
 * Canonical owner: verification/harnesses/run-phase7-tests.mjs
...
await runCompatibilityCli(new URL('../verification/harnesses/run-phase7-tests.mjs', import.meta.url));
