...
const EVIDENCE_ROOT = path.join(ROOT, 'reports', 'validation-evidence', 'phase8');
...
const VERIFICATION_ROOT = path.join(ROOT, 'docs', 'verification', 'phase8');
...
async function loadCodeReview() {
  ...
  try {
    ...
    return {
      completed: false,
      findings: [],
      reportPath: 'reports/validation-evidence/phase8/p8-m11-code-review.md',
    };
  }
}
