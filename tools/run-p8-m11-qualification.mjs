 ...
 * Canonical owner: verification/runners/run-p8-m11-qualification.mjs
...
await runCompatibilityCli(new URL('../verification/runners/run-p8-m11-qualification.mjs', import.meta.url));
