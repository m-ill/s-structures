 ...
 * Canonical owner: verification/harnesses/run-phase9-tests.mjs
...
await runCompatibilityCli(new URL('../verification/harnesses/run-phase9-tests.mjs', import.meta.url));
