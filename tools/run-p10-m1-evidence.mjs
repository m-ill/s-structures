 ...
 * Canonical owner: verification/runners/run-p10-m1-evidence.mjs
...
await runCompatibilityCli(new URL('../verification/runners/run-p10-m1-evidence.mjs', import.meta.url));
