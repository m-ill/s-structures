 ...
 * Canonical owner: verification/harnesses/run-phase8-tests.mjs
...
await runCompatibilityCli(new URL('../verification/harnesses/run-phase8-tests.mjs', import.meta.url));
