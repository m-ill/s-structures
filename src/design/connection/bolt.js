...
export function designBoltGroup(row = {}, options = {}) {
  ...
  return { version: BOLT_CONNECTION_VERSION, memberId: row.memberId, bolt: options.bolt || 'M20-F10T', requiredCount: required, ratio, status: ratio > 1 ? 'NG' : ratio > 0.8 ? 'WARN' : 'OK', formulaId: 'KDS-CONN-BOLT-V1' };
}
