...
export function createSparseFactorRuntime(options = {}) {
  ...
  function prepare(input, prepareOptions = {}) {
    ...
    const handle = Object.freeze({
      ...
      pivotMin: numeric.factor.pivotMin ?? null,
      pivotMinIndex: numeric.factor.pivotMinIndex ?? null,
      pivotMinOriginalIndex: numeric.factor.pivotMinOriginalIndex ?? numeric.factor.pivotMinIndex ?? null,
      pivotMax: numeric.factor.pivotMax ?? null,
      pivotRatio: numeric.factor.pivotRatio ?? null,
...
function handleDiagnostics(handle) {
  return {
    ...
    pivotMin: handle.pivotMin,
    pivotMinIndex: handle.pivotMinIndex,
    pivotMinOriginalIndex: handle.pivotMinOriginalIndex,
    pivotMax: handle.pivotMax,
    pivotRatio: handle.pivotRatio,
