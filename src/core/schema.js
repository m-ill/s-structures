...
export const ERROR_CODES = {
  ...
  BAD_MEMBER_INSERTION_POINT: 'BAD_MEMBER_INSERTION_POINT',
  BAD_MEMBER_TAPER: 'BAD_MEMBER_TAPER',
  BAD_MEMBER_TAPER_PROFILE: 'BAD_MEMBER_TAPER_PROFILE',
  BAD_MEMBER_TAPER_GAUSS_POINTS: 'BAD_MEMBER_TAPER_GAUSS_POINTS',
  BAD_MEMBER_TAPER_SECTION: 'BAD_MEMBER_TAPER_SECTION',
  BAD_MEMBER_TAPER_SEGMENTS: 'BAD_MEMBER_TAPER_SEGMENTS',
  BAD_PANEL_ZONE: 'BAD_PANEL_ZONE',
  PANEL_ZONE_SPRING_CONFLICT: 'PANEL_ZONE_SPRING_CONFLICT',
  PANEL_ZONE_FRAME_REQUIRED: 'PANEL_ZONE_FRAME_REQUIRED',
  BAD_CONSTRAINT: 'BAD_CONSTRAINT',
  BAD_CONSTRAINT_COLLECTION: 'BAD_CONSTRAINT_COLLECTION',
  BAD_CONSTRAINT_TYPE: 'BAD_CONSTRAINT_TYPE',
  BAD_CONSTRAINT_NODE_REF: 'BAD_CONSTRAINT_NODE_REF',
  BAD_CONSTRAINT_DOF_REF: 'BAD_CONSTRAINT_DOF_REF',
  BAD_CONSTRAINT_TERMS: 'BAD_CONSTRAINT_TERMS',
  BAD_CONSTRAINT_COEFFICIENT: 'BAD_CONSTRAINT_COEFFICIENT',
  BAD_CONSTRAINT_OFFSET: 'BAD_CONSTRAINT_OFFSET',
  BAD_CONSTRAINT_DOF_SELECTION: 'BAD_CONSTRAINT_DOF_SELECTION',
  DUPLICATE_CONSTRAINT_ID: 'DUPLICATE_CONSTRAINT_ID',
  CONSTRAINT_SLAVE_REDEFINED: 'CONSTRAINT_SLAVE_REDEFINED',
  CONSTRAINT_CYCLE: 'CONSTRAINT_CYCLE',
  CONSTRAINT_SUPPORT_CONFLICT: 'CONSTRAINT_SUPPORT_CONFLICT',
  ...
  BAD_RELEASE_SPRING: 'BAD_RELEASE_SPRING',
  RELEASE_SPRING_CONFLICT: 'RELEASE_SPRING_CONFLICT',
  RELEASE_SPRING_FRAME_REQUIRED: 'RELEASE_SPRING_FRAME_REQUIRED',
  ...
  BAD_LOAD_SHELL_REF: 'BAD_LOAD_SHELL_REF',
  BAD_LOAD_SHELL_TARGET: 'BAD_LOAD_SHELL_TARGET',
  ...
  BAD_NONLINEAR_QUALIFICATION: 'BAD_NONLINEAR_QUALIFICATION',
  BAD_TIME_HISTORY_FUNCTION: 'BAD_TIME_HISTORY_FUNCTION',
  BAD_ANALYSIS_STATE: 'BAD_ANALYSIS_STATE',
  BAD_NONLINEAR_ANALYSIS_CASE: 'BAD_NONLINEAR_ANALYSIS_CASE',
  BAD_NONLINEAR_INITIAL_STATE: 'BAD_NONLINEAR_INITIAL_STATE',
  NONLINEAR_ENGINE_REQUIRED: 'NONLINEAR_ENGINE_REQUIRED',
  NONLINEAR_ENGINE_UNKNOWN: 'NONLINEAR_ENGINE_UNKNOWN',
  NONLINEAR_ENGINE_CASE_MISMATCH: 'NONLINEAR_ENGINE_CASE_MISMATCH',
