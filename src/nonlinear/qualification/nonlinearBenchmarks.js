import { estimateCantileverLargeDisplacement, geometricStiffnessTrace } from '../elements/corotationalBeam.js';
import { solveNewtonRaphson } from '../control/newtonRaphson.js';
...
import { comparePushoverRegression, runFormalPushover } from '../pushoverFormal.js';
import { buildRectangularFiberSection } from '../fiber/fiberSection.js';
import { compareMomentCurvatureTheory, computeMomentCurvature } from '../fiber/momentCurvature.js';
...
/**
 * Canonical owner for the reusable nonlinear qualification cases consumed by
 * the P3-M14/M15/M16 trace contracts and by verification runners.
 *
 * This module lives with the nonlinear engine so production trace builders do
 * not depend upward on the verification layer. Verification-specific
 * orchestration remains in `verification/framework/**`.
 */
