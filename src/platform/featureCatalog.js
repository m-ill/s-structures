  ...
  },
  {
    ...
    features: [
      ...
      feature('analysis-center', 'Analysis Center', 'Phase 5 analysis case workflow for static, modal, RSA, buckling, THA, pushover, and NLTH.', {
        ...
        relatedActions: ['addAnalysisCase', 'updateAnalysisCase', 'deleteAnalysisCase', 'listAnalysisCases', 'runAnalysisCase', 'runAnalysisCases', 'runAllAnalysisCases'],
        relatedReadApis: ['getAnalysisCases', 'listAnalysisCases', 'getAnalysisResults', 'getAnalysisCaseResult', 'getCalculationPackage'],
        manualPage: '02-modeling-and-elastic-analysis.md',
        toggleable: true,
      }),
  ...
  },
  {
    ...
    features: [
      feature('pushover', 'Pushover 해석', '소성힌지 기반 비선형 정적 — capacity curve, 힌지 상태 이력, 수렴 로그.', {
        ...
        relatedActions: ['runPushover', 'setPushoverOption', 'setPushoverPanelOpen', 'runNativePushoverReport', 'assignHinge', 'removeHinge'],
        relatedReadApis: ['runPushover', 'getHingeAssignments'],
        manualPage: '07-nonlinear-analysis.md',
        toggleable: true,
      }),
