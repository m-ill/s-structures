...
const ROWS = [
  ...
  ], ['getPhase3ImportMilestoneReview', 'getPhase3DrawingImportValidationReview'], ['verification/specs/P3_M6_IMPORT_VERIFICATION.md', 'verification/specs/P3_M7_IMPORT_REVIEW_VERIFICATION.md']),
  ...
  ], ['getPhase3ImportMilestoneReview', 'getPhase3PointCloudValidationReview'], ['verification/specs/P3_M8_POINTCLOUD_LOAD_VERIFICATION.md', 'verification/specs/P3_M9_POINTCLOUD_EXTRACTION_VERIFICATION.md']),
  ...
  ], ['getPhase3ElasticMilestoneReview'], ['verification/specs/P3_M10_MATERIAL_LIBRARY_VERIFICATION.md', 'verification/specs/P3_M13_LOADS_DYNAMICS_VERIFICATION.md']),
  ...
  ], ['getPhase3NonlinearMilestoneReview', 'getPhase3EngineeringValidationReview', 'getNonlinearAnalysisTrace'], ['verification/specs/P3_M14_NONLINEAR_GEOMETRY_VERIFICATION.md', 'verification/specs/P3_M16_FIBER_NLTH_VERIFICATION.md']),
  ...
  ], ['getPhase3DesignMilestoneReview', 'getPhase3EngineeringValidationReview', 'getP3DetailedDesignReport'], ['verification/specs/DESIGN_MODULE_VERIFICATION.md']),
