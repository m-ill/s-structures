...
const SERVER_ENDPOINTS = [
  ...
  endpoint('GET', '/api/projects/:id/evidence', 'viewer+', 'server/routes/evidence.mjs'),
  endpoint('POST', '/api/projects/:id/evidence', 'engineer+', 'server/routes/evidence.mjs'),
...
const FRONTEND_CONTRACT = {
  ...
  modules: [
    ...
    'src/viewer/modelLayer.js',
    'src/viewer/sliceControl.js',
    'src/viewer/picking.js',
  ],
...
const MILESTONES = [
  ...
  ms('P3-M9', t(41, 45), ['verification/specs/P3_M9_POINTCLOUD_EXTRACTION_VERIFICATION.md'], ['tests/p3-pointcloud-extraction.mjs', 'tests/p3-pointcloud-e2e.mjs']),
  ms('P3-M10', t(46, 49), ['verification/specs/P3_M10_MATERIAL_LIBRARY_VERIFICATION.md'], ['tests/p3-m10-materials.mjs', 'tests/p3-section-properties.mjs']),
  ms('P3-M11', t(68, 72), ['verification/specs/P3_M11_ELASTIC_EXPANSION_VERIFICATION.md'], ['tests/p3-m11-elastic-expansion.mjs']),
  ms('P3-M12', t(73, 75), ['verification/specs/P3_M12_WALL_SLAB_VERIFICATION.md'], ['tests/p3-m12-wall-slab.mjs']),
  ms('P3-M13', t(76, 82), ['verification/specs/P3_M13_LOADS_DYNAMICS_VERIFICATION.md'], ['tests/p3-m13-loads-dynamics.mjs']),
  ms('P3-M14', t(50, 53), ['verification/specs/P3_M14_NONLINEAR_GEOMETRY_VERIFICATION.md'], ['tests/p3-m14-nonlinear-geometry.mjs']),
  ms('P3-M15', t(54, 56), ['verification/specs/P3_M15_HINGE_CONTROL_VERIFICATION.md'], ['tests/p3-m15-nonlinear-hinge-control.mjs']),
  ms('P3-M16', t(83, 86), ['verification/specs/P3_M16_FIBER_NLTH_VERIFICATION.md'], ['tests/p3-m16-nonlinear-fiber-nlth.mjs']),
  ms('P3-M17', t(87, 90), ['verification/specs/DESIGN_MODULE_VERIFICATION.md'], ['tests/p3-design-rc.mjs']),
  ms('P3-M18', t(91, 95), ['verification/specs/DESIGN_MODULE_VERIFICATION.md'], ['tests/p3-design-steel-foundation.mjs']),
  ms('P3-M19', ['P3-T58', 'P3-T59', 'P3-T61', 'P3-T62'], ['verification/specs/DESIGN_MODULE_VERIFICATION.md'], ['tests/p3-m19-integrated-report.mjs']),
  ms('P3-M20', t(63, 67), ['verification/specs/P3_M20_LAUNCH_READINESS_VERIFICATION.md'], ['tests/p3-launch-gate.mjs', 'tests/p3-runner-contract.mjs', 'tests/p3-doc-reference-integrity.mjs', 'tests/p3-server-route-contract.mjs']),
];
