import { denseToCsc } from './cscMatrix.js';
import { applyPermutationVector, invertPermutation, unpermuteVector } from './symbolicFactor.js';

export const SPARSE_LDLT_VERSION = 'p7-m10-sparse-ldlt-v2';
...
export function solveLdlt(factor, rhs) {
  ...
  if (!Array.isArray(rhs) || rhs.length !== n || rhs.some((value) => !Number.isFinite(Number(value)))) {
