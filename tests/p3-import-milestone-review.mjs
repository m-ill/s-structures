...
assert.equal(review.rows[1].exitCriteria.find((row) => row.id === 'M7-E1').source, 'docs/archive/phase3/IMPORT_DXF_DWG_PLAN.md');
assert.equal(review.rows[3].exitCriteria.find((row) => row.id === 'M9-E4').source, 'docs/archive/phase3/IMPORT_POINT_CLOUD_PLAN.md');
