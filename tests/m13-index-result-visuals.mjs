...
assert.equal(analysis.designEligibility.eligible,false);
assert.ok(visuals.members.every(member=>member.ratio===null&&member.status==='none'),'blocked design must not borrow a preliminary force-check ratio');
