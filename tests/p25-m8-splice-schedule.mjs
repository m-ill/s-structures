...
const font=new Uint8Array(readFileSync('assets/fonts/phase24/SStructuresSans.ttf'));mkdirSync('output/pdf/phase25',{recursive:true});writeFileSync('output/pdf/phase25/splice-schedule.pdf',buildVectorDetailPdf(drawing.pages,font));writeFileSync('output/pdf/phase25/splice-schedule.json',JSON.stringify(pages));
...
writeFileSync('output/pdf/phase25/splice-incomplete.pdf',buildVectorDetailPdf(incomplete.pages,font));
