...
assert.equal(artifact.environment.equilibriumAssembler, 'p8-m4-mdof-equilibrium-assembler-v3');
assert.equal(MDOF_EQUILIBRIUM_ASSEMBLER_VERSION, 'p9-m7-mdof-equilibrium-assembler-v4');
