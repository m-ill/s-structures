...
const combined=memberReinforcementProposal([command],[row,{id:'C',entityId:'M',checkId:'rc-confinement',status:'NG',tieSpacingRequirements:[{detailId:'R',detailVersion:1,maxSpacing:150,needsRepair:true}]}]);
...
const withSpacing=memberReinforcementProposal([{...command,stirrupSpacing:400,tieFirstStart:.2,tieFirstEnd:.2}],[row,{id:'C',entityId:'M',checkId:'rc-confinement',status:'NG',tieSpacingRequirements:[{detailId:'R',detailVersion:1,maxSpacing:150,needsRepair:true}]}]);
...
const catalogCombined=memberReinforcementProposal([{...catalog,stirrupSpacing:400}],[row,{id:'C2',entityId:'M',checkId:'rc-confinement',status:'NG',tieSpacingRequirements:[{detailId:'R',detailVersion:1,maxSpacing:150,needsRepair:true}]}]);assert.equal(catalogCombined.productChoices[0].catalogId,REBAR_CATALOG_ID);
