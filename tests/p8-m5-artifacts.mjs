...
const artifact = JSON.parse(readFileSync(new URL('../reports/validation-evidence/phase8/p8-m5-formal-pushover.json', import.meta.url)));
...
for (const path of [
  ...
  '../reports/validation-evidence/phase8/p8-m5-code-review.md',
]) {
