...
const evidence = JSON.parse(await readFile('verification/evidence/validation/phase9/p9-m2-cpu-wasm.json', 'utf8'));
const manifest = JSON.parse(await readFile('verification/specs/phase9/release-manifest.json', 'utf8'));
