...
assert.match(hub, /completed_milestones:\s*\[P9-M0, P9-M1, P9-M2\]/);
assert.match(status, /phase_status:\s*implementation/);
assert.match(status, /implementation_status:\s*in-progress/);
assert.match(status, /completed_milestones:\s*\[P9-M0, P9-M1, P9-M2\]/);
...
assert.match(rootIndex, /documentationVersion:\s*2026-07-15-phase9-m2/);
