...
| P3-M12 | Preliminary | wall/slab equivalent trace tests, semi-rigid equivalent-brace redistribution, shell v1 patch and plate-deflection benchmarks |
...
| P3-M16 | Preliminary | `fiberNlthGate`, member-derived PMM/fiber, material-backbone/NLTH/ground-motion trace, and B6-B8 tests |
