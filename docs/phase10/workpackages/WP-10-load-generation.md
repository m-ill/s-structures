...
| 날짜 | 지적 | 조치 | 상태 |
| --- | --- | --- | --- |
| 2026-07-22 | LG-01~02 슬래브 분배 평형과 fixed-end 소비 계약 | 1방향 UDL, 2방향 구간별 삼각·사다리꼴 하중 및 `qA` 평형 gate 구현 | 완료 |
| 2026-07-22 | LG-03 생성 하중 질량 중복 가능성 | `generatedKey` dedup을 기존 `buildMassSourceTrace` 앞단에 연결 | 완료 |
| 2026-07-22 | LG-04 수동 풍 부담폭·풍상/풍하 trace 부족 | 모델 기하 부담폭과 양/음 압력면 trace 구현 | 완료 |
