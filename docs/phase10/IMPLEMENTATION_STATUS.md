...
completed_milestones: [P10-M0, P10-M1]
active_milestone: null
decision_gates_pending: [ADR-001(warping/LTB 방식), ADR-002(shell 옵션 B 번복 — 오너 승인)]
owner_inputs_pending: [XV-02~08 외부 기준해 artifact (OpenSees/SAP2000/ETABS), RSA V_min 기준값 정책]
```
...
XV-03~08은 `pending-reference`, XV-09/10은 후속 마일스톤 대기이며,
...
| P10-M2 Timoshenko 전단변형 | planned | 없음 |
...
P10-M2 Timoshenko 전단변형 착수가 다음 구현 순서다. 동시에 오너에게 XV-02~08 외부 기준해 입력 일정과
ADR-002 승인 여부를 확인한다. XV-09는 M2,
