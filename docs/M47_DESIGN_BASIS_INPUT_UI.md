...
- Adds a structured input state for occupancy, gravity load intensities, wind pressure, and seismic coefficients.
...
- Adds a compact elastic-analysis ribbon group with occupancy, D/L/Lr, WX/WY, EX/EY, Preview, Apply, and status controls.
