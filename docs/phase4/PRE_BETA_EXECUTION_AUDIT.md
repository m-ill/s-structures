...
| WP-08 | complete-for-pre-beta | `tools/build-release.mjs`, `tools/backup-data.mjs`, `server/auth/license.mjs`, `tools/issue-license.mjs`, `config.sample.json`, `CHANGELOG.md`, `desktop/`; `tests/p4-release-tools.mjs`, `tests/p4-backup-tool.mjs`, `tests/p4-build-release.mjs`. |
