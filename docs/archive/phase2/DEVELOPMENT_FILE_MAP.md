...
| 기준식 registry 추가 | `docs/archive/phase2/STANDARD_ENGINE_PLAN.md`, `src/standards/` 예정 |
...
| --- | --- |
| Direct Analysis P-Delta implementation | `docs/archive/phase2/P2_M5_DIRECT_ANALYSIS_IMPLEMENTATION_PLAN.md`, `src/solver/linear3d*.js`, `src/results/pDeltaTrace.js` |
...
| 개발 트랙 변경 | `docs/archive/phase2/README.md` |
