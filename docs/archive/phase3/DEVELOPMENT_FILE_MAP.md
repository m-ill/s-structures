...
Phase 2 지도(`docs/archive/phase2/DEVELOPMENT_FILE_MAP.md`)를 계승한다. 여기는 Phase 3 신규/변경 위치만 기록한다.
...
| 하려는 작업 | 먼저 볼 파일 |
| --- | --- |
| API 추가/변경 | `docs/archive/phase3/SERVER_API_PLAN.md`, `server/routes/`, `tests/p3-server-api.mjs` |
