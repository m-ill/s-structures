...
The next milestone track is documented in `docs/archive/post-phase5/MILESTONE_STATUS.md`. Its first gate is `POST-P5-M1`, exposed through `getFinalUseReleaseReview()`, and it keeps Phase 5 completion separate from final production-use approval.
