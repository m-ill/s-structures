...
documentationVersion: 2026-07-02-phase3-prep
...
| `phase3/` | 현재 active 개발 계획 (제품화: import, 재료, 비선형, 플랫폼) | active planning과 개발 handoff 중심 |
| `phase2/` | Phase 2(탄성 실무 검토 MVP, 완료) 계획 기록 | MVP 완료. 참조용 유지, 신규 계획은 phase3에 작성 |
...
| `verification/` | 수치 검증, solver 검증 근거 | 테스트와 수학적 검증 근거 중심 |
...
## Phase 3 Reading Order (current)

Phase 3 개발을 시작할 때는 아래 순서로 읽는다.

1. `docs/user-manual/STATUS_AND_LIMITS.md`
2. `docs/user-manual/AI_AGENT_GUIDE.md`
3. `docs/phase3/README.md`
4. `docs/phase3/PRODUCT_REQUIREMENTS.md`
5. `docs/phase3/ROADMAP.md`
6. `docs/phase3/ARCHITECTURE.md`
7. 착수 영역의 상세 계획 문서 (`docs/phase3/`)
8. `docs/phase3/IMPLEMENTATION_BACKLOG.md`
9. `docs/phase3/DEVELOPMENT_FILE_MAP.md`
