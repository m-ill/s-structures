...
| WP | Milestone | 이름 | 상태 |
| --- | --- | --- | --- |
| [WP-00](WP-00-baseline-governance.md) | P11-M0 | Baseline·범위·governance | planned |
| [WP-01](WP-01-report-snapshot-verdict.md) | P11-M1 | ReportSnapshot·verdict | planned |
| [WP-02](WP-02-i18n-dual-render.md) | P11-M2 | 한·영 현지화·dual HTML | planned |
| [WP-03](WP-03-visual-capture-core.md) | P11-M3 | 결정론적 visual capture core | planned |
