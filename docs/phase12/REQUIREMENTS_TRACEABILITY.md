...
| P12-FR-BOUNDARY-01 | 공개 allowlist와 private 경계 | M1 | P12-BOUNDARY-01~08 | planned |
| P12-FR-MIG-01 | 비파괴 이전과 key rotation | M2 | P12-MIG-01~04, P12-KEY-01~02 | planned |
| P12-FR-HTTP-01 | HTTP·인증·quota 방어 | M3 | P12-HTTP-01~03, P12-AUTH-01, P12-QUOTA-01 | planned |
| P12-FR-APR-01 | rev-bound 승인·릴리스 | M4 | P12-APR-01~08 | planned |
